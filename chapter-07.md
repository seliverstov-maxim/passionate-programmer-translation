...
В рамках быстроизменяемого окружения гибкость будет доминировать. Когда сроки сжаты, опытный
...
человека, который не только знает, как руководить людьми и проектами, но может еще, закатав рукава,
исправить в последнюю минуту некоторые критические баги, пока удалённые (_offshore_) работники
...
непрактичным. То же самое происходит с .NET vs. J2EE и другими такими же платформами. Перспектива
